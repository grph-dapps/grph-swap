...
function contract({privateKey, api, version, net, contractAddress}) {
  ...
  const code = readFileSync(resolve(process.cwd(), "scilla/contracts", "GrphStake.scilla"), "utf8");
  let initParams = [{"vname":"contract_owner","type":"ByStr20"},{"vname":"stake_token","type":"ByStr20"},{"vname":"reward_token","type":"ByStr20"},{"vname":"start_rate","type":"Uint128"},{"vname":"token_multiplier","type":"Uint128"},{"vname":"is_mint","type":"Bool"},{"vname":"is_zil","type":"Bool"}];
  ...
  return {
    ...
    async deploy(contract_owner, stake_token, reward_token, start_rate, token_multiplier, is_mint, is_zil, gasLimit = 60000) {
    ...
    async Init(gasPrice = 2000,gasLimit = 2000, zilAmount = 0, callback) {
    ...
    },async SetMinAmount(amount, gasPrice = 2000,gasLimit = 2000, zilAmount = 0, callback) {
        const args = arguments;
        const e = new Error();
        const frame = e.stack.split("\n")[1];
        const tag = frame.split(" ")[5].split(".")[1];
        ...
        return confirmedTxn.receipt.success === true;
    },async Withdraw(amount, gasPrice = 2000,gasLimit = 2000, zilAmount = 0, callback) {
        const args = arguments;
        const e = new Error();
        const frame = e.stack.split("\n")[1];
        const tag = frame.split(" ")[5].split(".")[1];
        ...
        return confirmedTxn.receipt.success === true;
    },async Claim(gasPrice = 2000,gasLimit = 2000, zilAmount = 0, callback) {
        const args = arguments;
        const e = new Error();
        const frame = e.stack.split("\n")[1];
        const tag = frame.split(" ")[5].split(".")[1];
    ...
    fields: {"owner":{"owner":"owner","ByStr20":"ByStr20"},"pending_owner":{"pending_owner":"pending_owner","Option (ByStr20)":"Option (ByStr20)"},"lastUpdatedBlock":{"lastUpdatedBlock":"lastUpdatedBlock","Uint128":"Uint128"},"rewardPerTokenStored":{"rewardPerTokenStored":"rewardPerTokenStored","Uint128":"Uint128"},"totalSupply":{"totalSupply":"totalSupply","Uint128":"Uint128"},"rewardRate":{"rewardRate":"rewardRate","Uint128":"Uint128"},"minAmount":{"minAmount":"minAmount","Uint128":"Uint128"},"balances":{"balances":"balances","Map (ByStr20) (Uint128)":"Map (ByStr20) (Uint128)"},"userRewardsPerTokenPaid":{"userRewardsPerTokenPaid":"userRewardsPerTokenPaid","Map (ByStr20) (Uint128)":"Map (ByStr20) (Uint128)"},"rewards":{"rewards":"rewards","Map (ByStr20) (Uint128)":"Map (ByStr20) (Uint128)"},"is_closed":{"is_closed":"is_closed","Bool":"Bool"},"closed_block":{"closed_block":"closed_block","BNum":"BNum"},"claimedAfterClose":{"claimedAfterClose":"claimedAfterClose","Map (ByStr20) (Bool)":"Map (ByStr20) (Bool)"}}
  };  
};
